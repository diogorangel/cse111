...
def test_pressure_gain_from_water_height():
    """Test the pressure_gain_from_water_height function with different inputs."""
...
def test_pressure_loss_from_pipe():
    """Test the pressure_loss_from_pipe function with different inputs."""
